...
function Dashboard() {
    ...
    return (
        <div className='max-h-screen overflow-hidden'>
            <div >
                <DashboardNav  setType={setType} isActive={isActive} EditPopup={EditPopup} setEditPopup={setEditPopup} setShowTaskModal={setShowTaskModal} BoardName={boardName} DeleteId={isActive} refetch={refetch} />
            </div>
            ...
            <div className='flex flex-row '>
                ...
                {/* ----Dasboard-content--- */}
                <div className='w-[80%] pb-24 bg-[#f4f7fd] min-h-screen overflow-y-auto px-[1%] py-3' style={{ maxHeight: "calc(100vh - 10rem)" }}>
                    <div>
                        {
                            isActive ?
                                <DashboardColumn setType={setType} id={isActive} Datas={data} ShowTaskModal={ShowTaskModal} setShowTaskModal={setShowTaskModal} /> : <div className="flex min-h-screen w-full justify-center items-center text-xl font-medium text-green-500">Todos are empty ! Please create new Board & Todos .</div>
                        }
                    </div>
                </div>
